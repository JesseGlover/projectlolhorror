...
////////////////////////////////////////////////////////
class WaterBulletComponent final : public IEntityComponent
{
public:
	// Destructor for the bullet component.
	virtual ~WaterBulletComponent() {}
	...
	static void ReflectType(Schematyc::CTypeDesc<WaterBulletComponent>& desc)
	{
